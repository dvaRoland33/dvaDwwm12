...
import img1 from "/src/assets/images/clients.jpg"
import img2 from "/src/assets/images/entretien.jpg"
    ...
    return (
        <div className="pe-4 ps-4 py-5">  
            <article className="row d-flex">
			      ...
			      <div className="col-12 col-md-6">
		  		    <h2>BIENVENUE CHEZ <strong className="txt-orange"> CLUB AUTO</strong> </h2>
