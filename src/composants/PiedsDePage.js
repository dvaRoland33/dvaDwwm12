                    ...
                    <div className="col-12 col-md-3">
			            ...
			            <form action="#" >
                            <div class="input-group mb-2 ms-2">
                                <input type="email" class="form-control" placeholder="Entrez votre Email" aria-label="Entrez votre Email"  />
                                <span class="input-group-text" ><img src={logoOndes} alt="ondes" className="iconeBandeau" /></span>
                            </div>
