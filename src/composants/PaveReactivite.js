...
class PaveReactivite extends React.Component {
  ...
  render(){
      return(    
        <div className="d-flex ">        
            ...
            <div className="col"> 
                <h3 className="text-uppercase txt-noir fbandeau ">Reactivité de l'équipe technique</h3>  
