                      ...
                      <div className="row">
                        <div className="col-6">
                            <label for="prenom">Pr&eacute;nom*
                                <input className="form-control champContact" id="prenom" name="prenom"
                                type="text" placeholder="Entrez Votre Pr&eacute;nom"/>
                            </label>
                        </div>
                        <div className="col-6">
                            <label for="nom">Nom*
                                <input className="form-control champContact" id="nom" name="nom"
                      ...
                      <div className="row">
                        <div className="col-6">
                            <label for="email">Email*
                                <input className="form-control champContact" id="email" name="email"                                type="text" placeholder="Entrez une adresse email valide"/>
                            </label>
                        </div>
                        <div className="col-6">
